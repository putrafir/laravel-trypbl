...
@section('container')
    ...
    @include('partials.pages')
      ...
      <div class="grid grid-cols-3">
        ...
        <div
          class="w-[19rem] h-[11rem] bg-white rounded-2xl shadow-lg flex flex-wrap mt-8"
        >
          <div class="w-full h-full flex flex-wrap">
            ...
            <div class="lg:w-1/2 pl-20 pt-4">
              ...
              >
                ...
                />
                <path
                  d="M31.5117 33.3623L32.3557 34.2041L34.1717 32.5291"
                  stroke="white"
                  stroke-width="1.28071"
                  stroke-linecap="round"
                  stroke-linejoin="round"
        ...
        <!-- kolom2 -->
        <div
          class="w-[19rem] h-[150px] bg-white rounded-2xl shadow-lg flex flex-wrap mt-8"
        >
          <div class="w-full h-full flex flex-wrap">
            <div class="p-5 lg:w-1/2">
              <h2 class="font-semibold text-secondary text-[1.3rem]">
      ...
      <div class="grid grid-cols-2 pt-6">
        <div
          class="w-[32rem] h-[16rem] relative bg-white rounded-2xl shadow-lg p-4 md:p-6"
        >
          <div class="flex justify-between mb-3">
            <div class="flex">
              <h5
                class="text-3xl absolute pl-[240px] pt-[2.3rem] font-bold text-dark pe-1"
              >
                Perbandingan
              </h5>
            </div>
        ...
        <div class="z-50">
          ...
          <div class="flex float-left mt-2 ml-56">
            ...
            >
              ...
              />
              <path
                d="M2.23047 3.27272L2.81446 3.85672L4.07095 2.69464"
                stroke="white"
                stroke-width="0.884848"
                stroke-linecap="round"
                stroke-linejoin="round"
        ...
        <div
          class="absolute w-[32rem] h-[220px] shadow-lg bg-blueFist rounded-2xl mt-[280px]"
        >
          <!-- Radial Chart -->
