<div class="w-[68rem] h-full bg-white shadow-lg rounded-xl mt-8">
    <div class="w-full h-full">
      ...
      <hr class="mx-6 mt-5" />
          ...
          <div class="grid grid-cols-6">
            <div class=" w-[65rem] h-[70px] flex flex-wrap bg-white shadow-sm mt-3 mx-6 rounded-xl border">
              ...
              <div class="pt-6 flex absolute pl-60">
                <h2 class="pl-[116px] text-sm text-slate-400">Anjay</h2>
                <h2 class="pl-[4rem] text-sm text-slate-400">Anjay</h2>
        ...
        <div class=" mt-6 max-w-sm flex justify-center content-center bg-white shadow-sm rounded-lg border p-5 mx-[30%]">
