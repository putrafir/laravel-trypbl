                    ...
                    <li>
                        ...
                        <form id="logOutForm" action="/logout" method="POST">
                            ...
                            <div
                                ...
                                <button class="flex" type="button" onclick="showModalLogout()">
...
<div id="confirmLogoutModal" class=" hidden fixed inset-0 z-50 flex items-center justify-center ">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apakah anda
                    yakin ingin <span class=" font-semibold">Log Out
                        ?</span>
                </h3>
                <button id="confirmButton" onclick="confirmLogout()" data-modal-hide="popup-modal" type="button"
                    class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                    Log Out
                </button>
                <button id="cancelButton" onclick="closeModalLogout()" data-modal-hide="popup-modal" type="button"
