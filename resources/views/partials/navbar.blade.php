<div class="container">
    ...
    >
      ...
      <a href="/">
      <div
        class="p-4 mt-3 flex items-center rounded-lg px-8 duration-300 cursor-pointe bg-opacity-35 "
      >
        <svg
          width="24"
          height="24"
        ...
        >
          ...
          />
          <path
            d="M10 17.75L9 21.25M14 17.75L15 21.25"
            stroke="#1068FF"
            stroke-width="1.5"
            stroke-linecap="round"
          />
      ...
      <a href="/pendaftar">
        <div
          class="p-4 flex items-center rounded-lg px-8 duration-300 cursor-pointe"
        >
          <svg
            width="24"
            height="24"
          ...
          <span class=" ml-5 text-slate-600 text-base text-sm"
            >Pendaftar</span
          >
        </div>
      </a>
      ...
      <a href="/diterima">
        <div
          class="p-4 flex items-center rounded-lg px-8 duration-300 cursor-pointer text-white"
        >
          <svg
            width="24"
            height="24"
          ...
          >
            ...
            />
            <path
              d="M6 16.5C6 14.8431 7.34315 13.5 9 13.5H10C11.6569 13.5 13 14.8431 13 16.5"
              stroke="#1068FF"
              stroke-width="1.5"
              stroke-linecap="round"
            />
          ...
          <span class="text-gray-600 ml-[19px] text-base text-sm"
            >Diterima</span
          >
        </div>
      </a>
      ...
      <a href="/dress">
        ...
        >
          ...
          <span class="text-gray-600 ml-[24px] text-base text-sm"
            >Ukuran baju</span
          >
        </div>
      </a>
      ...
      <a href="/tambah">
        ...
        >
          ...
          <span class="text-gray-600 ml-5 text-base text-sm"
            >Tambah pendaftar</span
          >
        </div>
      </a>
    </aside>
