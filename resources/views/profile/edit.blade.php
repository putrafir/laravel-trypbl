                        ...
                        <div class="relative inline-block">
                            @if ($user->profileImg)
                                <img id="profile-picture"
                                    ...
                                    src="{{ asset('storage/' . $pendaftar->profileImg) }}" alt="Profile Image" />
                            @else
                                <img id="profile-picture"
                                    class="w-14 h-14 object-cover rounded-full shadow-lg cursor-pointer"
                        ...
                        <div class="content text-dark active" id="dataDiri">
                            ...
                            <div class="grid-cols-2 w-[60rem] mt-6 pb-2 grid gap-x-20">
                                ...
                                <div class="mb-5">
                                    ...
                                    <input value="{{ old('username') }}" id="username" type="text" name="username"
                                ...
                                <div class="mb-5">
                                    ...
                                    <input value="{{ old('jabatan') }}" id="jabatan" type="text" name="jabatan"
                            ...
                            <div class="grid-cols-2 w-[60rem] mt-6 pb-2 grid gap-x-20">
                                <div class="mb-5">
                                    ...
                                    <input value="{{ old('alamat') }}" id="alamat" type="text" name="alamat"
                                ...
                                <div class="mb-5">
                                    ...
                                    <input value="{{ old('nomorTelepon') }}" id="nomorTelepon" type="text"
                                        name="nomorTelepon"
